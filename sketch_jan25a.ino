...
#define F_MIN            1000000UL      // Lower frequency limit  10 KHz
#define F_MAX        30000000UL      // Upper frequency limit 100 MHz
...
*  Declarations
**************************************************************************/
volatile uint32_t bfo_f = Promezh / SI5351_FREQ_MULT;   // CLK0 start IF
...
// Read EEPROM
  ...
  if ((bfo_f < F_MIN) | (bfo_f > F_MAX)) bfo_f = Promezh;  
